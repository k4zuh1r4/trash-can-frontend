...
export default function ListTransactions() {
    const { transactions, getUserTransactions, isLoadingTransactions } = useTransactionStore()
        ...
        <>
            ...
            <div className="flex justify-center items-center min-h-screen p-6 bg-base-100">
                ...
                <div className="w-full max-w-4xl">
                    <h1 className="text-3xl font-bold text-center text-primary mb-6">Transaction History</h1>
                            ...
                            {transactions.length > 0 ? (
                                ...
                                <div className="p-8 text-center">
                                    ...
                                    <p className="text-sm text-accent-content mt-2">
                                        Start by contributing trash to see your transactions here.
                                    </p>
                                </div>
                            ) : (
                                <div className="p-8 text-center">
